...
This repository contains all the learning materials for the course **Manual Software Testing with Black-Box Techniques**.
...
🌐 [https://skill-wanderer.com/](https://skill-wanderer.com/)